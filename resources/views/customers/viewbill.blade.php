...
@section('content')
    <div class="row">
        <div class="pull-right" style="margin-right: 100px;">
            <a href="{{url('deletemadeorder/' . $bill_id)}}" onclick="confirm('ທ່ານຕ້ອງການລົບລ້າງບິນນີ້ແທ້ບໍ?')" class="btn btn-danger">ລົບລ້າງບິນ</a>
            <a href="{{ url("billing/madeorder/$bill_id/$customer->id") }}" class="btnPrint btn btn-primary">Print preview</a>
        </div>
