...
class ReportSaleMadeOrderController extends Controller
{
    public function index(Request $request){
        ...
        if(($request->button == 'FILTER' or $request->button == 'PRINT') and $request->bill_no != ''){
            $sales = DB::table('madeorders')
                ->leftjoin('bills', 'bills.id', '=', 'madeorders.bill_id')
                ...
                ->select('bills.id as id',
                    ...
                    'madeorders.product as product_name',
        ...
        if($request->button == 'FILTER' or $request->button == null){
            return view('reports.saleMadeOrder.index', compact('sales', 'users', 'bill_no', 'customer_name', 'user_id', 'start_date', 'end_date'));
        }elseif($request->button == 'PRINT'){
            if($user_id != ''){
                $user = User::find($user_id);
                $user_name = $user['name'];
            }
            return view('reports.saleMadeOrder.print', compact('sales', 'users', 'bill_no', 'customer_name', 'user_id','user_name', 'start_date', 'end_date'));
        }
    }
    ...
    public function printpreview(Request $request){
        ...
        return view('reports.saleMadeOrder.printpreview', compact('sales', 'users', 'bill_no', 'customer_name', 'user_id', 'user_name', 'start_date', 'end_date'));
    }
}
