...
//Route::match(['get', 'post'], '/superAdminOnlyPage/', 'HomeController@super_admin');
    ...
    Route::get('company.showForm',[
        'uses' => 'CompanyController@showForm',
        'as' => 'company.showForm',
        'roles' => ['Super_admin', 'Admin']
    ]);
    ...
    Route::get('company.updateForm',[
        'uses' => 'CompanyController@edit',
        'as' => 'company.updateForm',
        'roles' => ['Super_admin', 'Admin']
    ]);
    ...
    Route::get('view.document',[
        'uses' => 'DocumentsController@index',
        'as' => 'view.document',
        'roles' => ['Super_admin', 'Admin']
    ]);
    Route::get('create.document', [
        'uses' => 'DocumentsController@showCreateForm',
        'as' => 'show.create.form',
        'roles' => ['Super_admin', 'Admin']
    ]);
    Route::post('store.document', [
        'uses' => 'DocumentsController@store',
        'as' => 'store.document',
        'roles' => ['Super_admin', 'Admin']
    ]);
    Route::get('open.file', [
        'uses' => 'DocumentsController@openFile',
        'as' => 'open.file',
        'roles' => ['Super_admin', 'Admin']
    ]);
    ...
    Route::get('view.shipping', [
        'uses' => 'BillingController@viewShipping',
        'as' => 'view.shipping',
        'roles' => ['Super_admin', 'Admin', 'Member']
    ]);
    ...
    Route::get('billing.shippingprintPreview', [
        'uses' => 'BillingController@shippingprintpreview',
        'as' => 'billing.shippingprintPreview',
        'roles' => ['Super_admin', 'Admin', 'Member']
    ]);
    ...
    Route::get('reportProductPrintpreview',[
        'uses' => 'reportProductPrintPreviewController@printpreview',
        'as' => 'reports.product.printpreview',
        'roles' => ['Super_admin', 'Admin']
    ]);
    ...
    Route::get('reportProfits',[
        'uses' => 'ReportProfitsController@index',
        'as' => 'reportProfits.index',
        'roles' => ['Super_admin', 'Admin']
    ]);
});
