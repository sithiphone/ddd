    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="font-size: 20px;">ແກ້ໄຂຮູບສິນຄ້າຈິງທີ່ຜະລິດໄດ້</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('update.product.finishphoto') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
