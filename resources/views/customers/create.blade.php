                        ...
                        <form method="POST" action="{{ route('customers.store') }}" class="form-horizontal">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="textinput" name="code" value="{{ $new_code }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="textinput" name="name" value="" placeholder="ຊື່ ແລະ ນາມສະກຸນລູກຄ້າ"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="textinput" name="mobile1" value="" placeholder="ເບີໂທຕິດຕໍ່ທີ 1"
                                               class="form-control input-md" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="textinput" name="mobile2" value="" placeholder="ເບີໂທຕິດຕໍ່ທີ 2"
                                               class="form-control input-md" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="textinput" name="email" value="" placeholder="ອີເມວ໌ຕິດຕໍ່"
